LinkLuaModifier("modifier_recon_systems_bot_aura","heroes/hero_keen/keen_commander_recon_systems.lua",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_recon_systems_bot_shock","heroes/hero_keen/keen_commander_recon_systems.lua",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_recon_systems_bot_slow","heroes/hero_keen/keen_commander_recon_systems.lua",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_recon_systems_null","heroes/hero_keen/keen_commander_recon_systems.lua",LUA_MODIFIER_MOTION_NONE)
